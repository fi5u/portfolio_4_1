...
<?php foreach ($postslist as $post) :  setup_postdata($post); ?>
    ...
    <?php $cover_id = get_field("cover_image"); ?>
    <?php $cover_url = wp_get_attachment_image_src( $cover_id, "home" ); ?>

    <div class="portfolio__item">
        <h3 class="portfolio__item__title"><?php the_title(); ?></h3>
        <div class="portfolio__item__visual" style="background-image:url(<?php echo $cover_url[0]; ?>);">
        </div>
